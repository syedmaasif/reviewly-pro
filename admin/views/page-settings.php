            ...
            <div class="rvly-card">
                ...
                <div class="rvly-setting-row">
                    ...
                    <div class="rvly-radio-group">
                        <label><input type="radio" name="require_approval" value="0" <?php checked( $settings['require_approval'], '0' ); ?>> Auto-Publish</label>
                        <label><input type="radio" name="require_approval" value="1" <?php checked( $settings['require_approval'], '1' ); ?>> Require Approval</label>
                    </div>
                ...
                <div class="rvly-setting-row">
                    ...
                    <input type="number" name="reviews_per_page" value="<?php echo esc_attr( $settings['reviews_per_page'] ); ?>" min="0" max="100" style="width:100px;">
                </div>

                <div class="rvly-setting-row">
                    <label>Redirect After Submission <span class="rvly-hint-sm">(leave blank to stay on page)</span></label>
                    <input type="url" name="redirect_url" value="<?php echo esc_attr( $settings['redirect_url'] ); ?>" placeholder="https://yoursite.com/thank-you" style="width:100%;">
                </div>
            </div>
            ...
            <div class="rvly-card">
                ...
                <div class="rvly-setting-row">
                    <label class="rvly-checkbox-label">
                        <input type="checkbox" name="show_date" value="1" <?php checked( $settings['show_date'], '1' ); ?>>
                ...
                <div class="rvly-setting-row">
                    <label class="rvly-checkbox-label">
                        <input type="checkbox" name="show_avatar" value="1" <?php checked( $settings['show_avatar'], '1' ); ?>>
                ...
                <div class="rvly-setting-row">
                    ...
                    <input type="text" name="accent_color" value="<?php echo esc_attr( $settings['accent_color'] ); ?>" class="rvly-color-picker">
                </div>
            </div>
